"""
Django settings for admvilla project.
...
SECRET_KEY = '8hq=7d&as@ts5-@$okkd4^^r6hd^=rv8v$s_0ss-lv%!o8+vtb'
...
WSGI_APPLICATION = 'admvilla.wsgi.application'
